        ...
        <div className="container mx-auto px-6 sm:px-12 md:px-16 lg:px-24 xl:px-32">
          <div className="text-center">
            ...
            <p className="mt-5 text-lg text-gray-700">
              Free forever, upgrade for AI-driven interview coaching, analytics, and exclusive features.
            </p>
          </div>

          {/* Pricing Cards */}
          <div className="flex gap-6 items-center flex-col mt-10 lg:flex-row lg:justify-center lg:items-end">
            {pricingTiers.map(({ title, monthlyPrice, buttonText, popular, inverse, features, redirect }, index) => (
              <div key={index} className={twMerge("card p-8 rounded-lg shadow-md", inverse && "border-black bg-black text-white")}>
                ...
                <button
                  ...
                  onClick={() => (title === "Pro" ? handlePayment(monthlyPrice) : router.push("/dashboard"))}
                  disabled={isProcessing || (title === "Pro" && !isScriptLoaded)}
                >
                  {isProcessing && title === "Pro" ? "Processing..." : buttonText}
                </button>
